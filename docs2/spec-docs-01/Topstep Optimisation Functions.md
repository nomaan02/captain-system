...
$$\Delta\sigma^2_{j+1} = \sigma^2\big(1 + 2\,n_t\,\bar{\rho}\big)$$
...
$$S_{j+1}(L_t, n_t) = \frac{\mu_b(L_b)}{\sigma\sqrt{1 + 2\,n_t\,\bar{\rho}}}$$
...
$$|L_t| + \rho_j < c \cdot e \cdot A \quad \text{AND} \quad n_t < N \quad \text{AND} \quad \bar{r}_b + \beta_b \cdot L_b > 0 \quad \text{AND} \quad \frac{\bar{r}_b + \beta_b \cdot L_b}{\sigma\sqrt{1 + 2\,n_t\,\bar{\rho}}} > \lambda$$
...
comparison = {
    ...
    sharpe_delta: cb_sharpe - baseline_sharpe,

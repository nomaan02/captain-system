...
**Severity:** RESOLVED (reclassified from HIGH on 2026-04-27 via Phase 3 batch B5_F-21)
(SA3-F06)
...
**Resolution:** by-design per Q-13 (decisions log 2026-04-27). Reclassified from HIGH to RESOLVED. `AWAITING_MANUAL` is the correct terminal state; doc 32 line 328 amended to `MANUAL programs_1_2_rerun(asset)` in Phase 3 batch B5_F-21.
